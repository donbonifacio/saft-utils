...
public final class SaftHeaderDiffTest extends SaftDiffTest {
    ...
    public List<DynamicTest> generateMismatchHeaderTests() {
        return generateTestForFields(Header.FIELDS, SaftDiffTest::createFieldMismatchTest);
    }
     ...
     */
    @TestFactory
    public List<DynamicTest> generateMatchHeaderTests() {
        return generateTestForFields(Header.FIELDS, SaftDiffTest::createFieldMatchTest);
    }
}
